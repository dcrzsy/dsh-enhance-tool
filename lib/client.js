...
const BoardCss = ":where(.enhc-board-overlay){position:fixed;inset:0;z-index:1300;background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);align-items:center;justify-content:center;display:flex}:where(.enhc-board){box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-elevation-prominent);border-radius:32px;width:min(1180px,100vw - 64px);height:min(760px,100vh - 64px);display:flex;flex-direction:column;overflow:hidden;color:var(--dsw-alias-label-primary)}:where(.enhc-board-header){box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:18px 16px 6px 20px;display:flex}:where(.enhc-board-title){font-size:16px;font-weight:500;line-height:24px}:where(.enhc-board-close){cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}:where(.enhc-board-close:hover){background:var(--dsw-alias-interactive-bg-hover)}:where(.enhc-board-toolbar){flex:none;flex-wrap:wrap;align-items:center;gap:8px;padding:0 20px 12px;display:flex}:where(.enhc-board-search){box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-3);height:34px;width:240px;color:var(--dsw-alias-label-primary);border-radius:8px;outline:none;padding:0 12px;font-size:13px;line-height:1.5}:where(.enhc-board-search:focus){box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}:where(.enhc-board-select){box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);height:34px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:17px;padding:0 12px;font-size:13px;line-height:22px}:where(.enhc-board-toggle){background:0 0;height:34px;color:var(--dsw-alias-label-secondary);cursor:pointer;border:none;border-radius:17px;align-items:center;gap:6px;padding:0 12px;font-size:13px;line-height:20px;display:inline-flex}:where(.enhc-board-toggle:hover){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}:where(.enhc-board-toggle[aria-pressed=true]){background:var(--dsw-specific-sidebar-nav-item-active);color:var(--dsw-alias-label-primary)}:where(.enhc-board-count){color:var(--dsw-alias-label-tertiary);margin-left:auto;font-size:12px;line-height:18px}:where(.enhc-board-cols){flex:1;min-height:0;display:flex;gap:12px;padding:0 20px 20px;overflow-x:auto}:where(.enhc-board-col){box-sizing:border-box;flex:1 1 0;min-width:180px;max-width:340px;background:var(--dsw-alias-bg-layer-1);border-radius:16px;flex-direction:column;display:flex;overflow:hidden}:where(.enhc-board-col-header){flex:none;align-items:center;gap:6px;padding:10px 10px 8px 12px;display:flex}:where(.enhc-board-col-name){font-size:13px;font-weight:500;line-height:20px}:where(.enhc-board-col-count){color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);border-radius:8px;padding:0 6px;font-size:11px;line-height:16px}:where(.enhc-board-col-actions){margin-left:auto;align-items:center;gap:2px;display:flex}:where(.enhc-board-icon){width:24px;height:24px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:12px;justify-content:center;align-items:center;padding:0;display:inline-flex;font-size:12px;line-height:16px}:where(.enhc-board-icon:hover){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}:where(.enhc-board-col-body){flex:1;min-height:0;flex-direction:column;gap:8px;padding:0 8px 8px;display:flex;overflow-y:auto}:where(.enhc-board-col[data-over=true]){box-shadow:inset 0 0 0 1.5px var(--dsw-alias-state-business-primary)}:where(.enhc-board-col[data-tone=danger][data-over=true]){box-shadow:inset 0 0 0 1.5px var(--dsw-alias-state-error-primary)}:where(.enhc-board-col[data-collapsed=true]){flex:0 0 44px;min-width:44px}:where(.enhc-board-col[data-collapsed=true]) :where(.enhc-board-col-name){writing-mode:vertical-rl;padding:2px 0}:where(.enhc-board-empty){color:var(--dsw-alias-label-tertiary);border:.5px dashed var(--dsw-alias-border-l2);border-radius:10px;justify-content:center;align-items:center;padding:16px 8px;font-size:12px;line-height:18px;display:flex}:where(.enhc-board-card){box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);border:.5px solid var(--dsw-alias-border-l2);border-radius:12px;flex-direction:column;gap:6px;padding:10px 12px;display:flex;cursor:grab;transition:background-color .12s var(--ds-ease-in-out)}:where(.enhc-board-card:hover){background:var(--dsw-alias-interactive-bg-hover)}:where(.enhc-board-card:focus-visible){outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}:where(.enhc-board-card[data-dragging=true]){opacity:.45}:where(.enhc-board-card[data-current=true]){border-color:var(--dsw-alias-state-business-primary)}:where(.enhc-board-card-title){font-size:14px;font-weight:500;line-height:22px;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}:where(.enhc-board-card-meta){color:var(--dsw-alias-label-tertiary);gap:6px;font-size:12px;line-height:18px;display:flex;min-width:0}:where(.enhc-board-card-meta) :where(.enhc-board-ws){text-overflow:ellipsis;white-space:nowrap;overflow:hidden}:where(.enhc-board-card-badges){flex-wrap:wrap;align-items:center;gap:6px;display:flex}:where(.enhc-board-badge){color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover);border-radius:8px;align-items:center;gap:4px;padding:0 6px;font-size:11px;line-height:16px;display:inline-flex}:where(.enhc-board-badge[data-tone=info]){color:var(--dsw-alias-state-business-primary)}:where(.enhc-board-badge[data-tone=success]){color:var(--dsw-alias-state-success-primary)}:where(.enhc-board-badge[data-tone=auto]){color:var(--dsw-alias-label-tertiary);background:0 0;padding:0}:where(.enhc-board-card-foot){align-items:center;gap:6px;display:flex}:where(.enhc-board-insert){height:2px;background:var(--dsw-alias-state-business-primary);border-radius:2px;margin:2px 0;flex:none}:where(.enhc-board-menu){flex-direction:column;gap:2px;background:var(--dsw-alias-bg-layer-2);border:.5px solid var(--dsw-alias-border-l2);border-radius:10px;margin-top:4px;padding:4px;display:flex}:where(.enhc-board-menu button){box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:8px;padding:0 8px;font-size:12px;line-height:18px}:where(.enhc-board-menu button:hover){background:var(--dsw-alias-interactive-bg-hover)}:where(.enhc-board-batch){align-items:center;gap:8px;background:var(--dsw-alias-bg-module-platform);border-radius:16px;padding:6px 10px;display:flex}:where(.enhc-board-batch-text){font-size:12px;line-height:18px;color:var(--dsw-alias-label-secondary)}:where(.enhc-board-pill){background:var(--dsw-alias-bg-module-platform);height:32px;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:16px;align-items:center;gap:6px;padding:0 12px;font-size:13px;line-height:20px;display:inline-flex}:where(.enhc-board-pill:hover:not(:disabled)){background:var(--dsw-alias-interactive-bg-hover)}:where(.enhc-board-pill[data-danger=true]){color:var(--dsw-alias-state-error-primary)}:where(.enhc-board-pill:disabled){opacity:.5;cursor:not-allowed}:where(.enhc-board-checkbox){width:16px;height:16px;accent-color:var(--dsw-alias-state-business-primary)}:where(.enhc-board-btn){width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:14px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}:where(.enhc-board-btn:hover){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}:where(.enhc-board-btn[aria-pressed=true]){background:var(--dsw-specific-sidebar-nav-item-active);color:var(--dsw-alias-label-primary)}:where(.enhc-board-hint){color:var(--dsw-alias-label-tertiary);padding:0 20px 12px;font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){:where(.enhc-board),:where(.enhc-board-card){transition:none!important}}";
...
/** The sessions service, published by apply() through ctx.inject. */
const boardBridge = { service: null, listeners: /* @__PURE__ */ new Set() };
/** Publish the sessions service to the board components. */
function boardSetService(service) {
...
function boardEmptyState() {
	return { version: 1, updatedAt: 0, entries: {}, collapsed: [] };
}
...
function boardAutoColumn(summary, jobs, now, recentDays) {
	...
	return age <= recentDays * BOARD_DAY_MS ? "todo" : "archived";
}
...
function boardView(state, list, now, options) {
	...
	for (const column of BOARD_COLUMNS) columns[column.key].sort((a, b) => a.order - b.order || (b.summary.updatedAt ?? 0) - (a.summary.updatedAt ?? 0));
...
const boardUi = { open: false, select: false, query: "", workspace: "", subs: false, all: false, dragged: null, over: null, menuFor: null, picked: [], confirmClear: false };
...
/** Header button that opens the board (sits right of the 轨迹 tab). */
function BoardButton() {
	boardCss();
	const ui = useBoardUi();
	const ref = (0, react.useRef)(null);
	useProductButtonStyle(ref);
	if (boardSettings.show !== true) return null;
	const label = ptL("任务看板", "Task board");
	return jsx("button", {
		ref,
		type: "button",
		className: "enhc-board-btn",
		title: label,
		"aria-label": label,
		"aria-pressed": ui.open,
		onClick: () => boardPatch({ open: !boardUi.open, menuFor: null, confirmClear: false, picked: [] })
	}, jsx("svg", {
		width: 16,
		height: 16,
		viewBox: "0 0 16 16",
		...
		d: "M2.5 2.5h3.2v11H2.5zM6.5 2.5h3.2v7.5H6.5zM10.5 2.5h3.2v9.5h-3.2z",
		fill: "currentColor"
	})));
}
/** One board card. */
function BoardCard({ card, column, ui, now, onOpen, onMove, onForget }) {
	...
	if (summary.completed === true) badges.push(jsx("span", { key: "done", className: "enhc-board-badge", "data-tone": "success", children: ptL("✓ 已完成", "✓ done") }));
	...
	if (card.manual !== true) badges.push(jsx("span", { key: "auto", className: "enhc-board-badge", "data-tone": "auto", children: ptL("自动", "auto") }));
	...
	return jsxs("div", {
		...
		children: [
			...
			jsxs("div", { key: "meta", className: "enhc-board-card-meta", children: [
				...
				jsx("span", { children: "·" }),
				jsx("span", { children: boardRelTime(summary.updatedAt, now) })
			] }),
			badges.length > 0 ? jsx("div", { key: "badges", className: "enhc-board-card-badges", children: badges }) : null,
			jsxs("div", { key: "foot", className: "enhc-board-card-foot", children: [
				jsx("button", {
					type: "button",
					className: "enhc-board-icon",
					title: ptL("移动 / 更多", "Move / more"),
...
function BoardDialog() {
	...
	(0, react.useEffect)(() => {
		...
		const sync = () => setList(source.getSnapshot());
		sync();
			...
			children: [
				...
				jsxs("div", { key: "toolbar", className: "enhc-board-toolbar", children: [
					jsx("input", {
						...
						value: ui.query,
						onChange: (event) => boardPatch({ query: event.currentTarget.value })
					}),
					workspaces.length > 1 ? jsx("select", {
						className: "enhc-board-select",
						value: ui.workspace,
						onChange: (event) => boardPatch({ workspace: event.currentTarget.value }),
						children: [
					...
					jsx("button", {
						...
						onClick: () => boardPatch({ subs: !ui.subs }),
					...
					] }) : jsx("span", { className: "enhc-board-count", children: ptL("共 " + view.total + " 个会话", view.total + " sessions") })
				] }),
				jsx("div", { key: "cols", className: "enhc-board-cols", children: BOARD_COLUMNS.map((column) => {
					...
					const stale = ui.all ? [] : cards.filter((card) => now - (card.summary.updatedAt ?? now) > BOARD_RECENT_DAYS * BOARD_DAY_MS);
					...
					return jsxs("div", {
						...
						children: [
							jsxs("div", { key: "h", className: "enhc-board-col-header", children: [
								...
								!collapsed ? jsx("span", { className: "enhc-board-col-name", children: column.label }) : null,
								...
								!collapsed ? jsxs("div", { className: "enhc-board-col-actions", children: [
									...
									column.key === "trash" && cards.length > 0 ? jsx("button", {
										...
										onClick: () => {
											...
											let next = state;
											for (const card of cards) next = boardForget(next, card.id);
											boardCommit(next);
											boardPatch({ confirmClear: false });
										},
										children: ui.confirmClear ? ptL("确认清空", "Confirm") : ptL("清空", "Empty")
									}) : null
								] }) : null
							] }),
							!collapsed ? jsx("div", {
								...
								children: cards.length === 0 ? jsx("div", { className: "enhc-board-empty", children: ptL("拖到此处", "Drop here") }) : [
									...cards.flatMap((card, index) => {
										const nodes = [];
										if (over === index) nodes.push(jsx("div", { className: "enhc-board-insert" }, "insert-" + card.id));
										nodes.push(jsx(BoardCard, { card, column: column.key, ui, now, onOpen: openSession, onMove: move, onForget: forget }, card.id));
										return nodes;
									}),
				...
				jsx("div", { key: "hint", className: "enhc-board-hint", children: ptL("拖拽卡片可跨列移动；「⋯」或按 M 打开移动菜单。垃圾桶只影响本看板，不会删除会话数据。", "Drag cards between columns; press M or ⋯ for the move menu. Trash only affects this board — no session data is deleted.") })
			]
		})
	});
}
...
//#region src/client/components.tsx
		...
		*/
		function apply(ctx) {
			...
			// The board button sits in `utilities`, i.e. immediately right of the 轨迹 tab
			// (the header renders: title cluster → actions → tabs → utilities → corner).
			ctx.slots.inject("conversation.session.header.utilities", () => ctx.slots.register({
				name: "conversation.session.header.utilities",
				id: "enhancer-board-button",
				order: 10
			}, () => react.createElement(BoardButton)));
